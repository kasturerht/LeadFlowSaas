...
with open(r'C:\Users\Admin\.gemini\antigravity\brain\3183cee6-4b5c-40f2-80c0-fd2fb5fda775\.system_generated\logs\transcript_full.jsonl', 'r', encoding='utf-8') as f:
    for line in f:
        obj = json.loads(line)
